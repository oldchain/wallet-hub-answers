...
@Component({
    ...
    template : `
                ...
                <div>
                    <input placeholder="first name" (change)='user.firstName=$event.target.value' [value]="user.firstName">
                    <input placeholder="last name"(change)='user.lastName=$event.target.value' [value]="user.lastName">
                    <span> {{user.firstName&&user.lastName ? generateUser() : ""}} </span>
                </div>
                `,
    styles : []
})
export class UserNameComponent {
    ...
    generateUser(){
        return this.user.firstName.toLowerCase() + '_' + this.user.lastName.toLowerCase() +'_'+ this.randomNumber()
    }
    randomNumber(){
