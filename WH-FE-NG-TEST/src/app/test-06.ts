...
@Component({
    ...
    template : `
                <h2>User Review:</h2>
                <textarea class="textfield" placeholder="Write your Review" (keyup)='review_content=$event.target.value' [value]="review_input"></textarea>
                <br/><br/>
                <h3>Output:</h3>
...
export class ReviewComponent {
    ...
    ngAfterContentChecked(){
        this.review_content = this.linkify(this.review_content);
    }
    linkify(text) {
